...
from sqlalchemy import BigInteger, Boolean, Date, DateTime, ForeignKey, Numeric, String, Time
...
class Transaction(Base):
    ...
    is_cardless: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
